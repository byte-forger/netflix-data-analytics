...
dashboard/netflix_dashboard.html       ← Interactive dashboard with 6 charts + filters
dashboard/netflix_cleaned_data.html    ← Browse, search, sort & export all 7,770 titles
```
